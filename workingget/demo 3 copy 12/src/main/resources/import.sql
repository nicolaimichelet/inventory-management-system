...
-- INSERT INTO SERVICE (dbid, name, href, category, is_stateful, SERVICE_ORDER_DBID, SERVICE_SPECIFICATION_DBID)
--   VALUES (1, 'name1', 'href1', 'RFS', true, 2, 1);
-- INSERT INTO SERVICE (dbid, name, href, category, is_stateful, SERVICE_ORDER_DBID, SERVICE_SPECIFICATION_DBID)
--   VALUES (2, 'name2', 'href2', 'CFS', false, 2, 2);
...
INSERT INTO SERVICE (dbid, category, description, end_date, has_started, href, id, is_service_enabled, is_stateful, name, order_date, start_date, start_mode, state, type, service_order_dbid, service_specification_dbid) VALUES (2, 'category1', 'description1', 'endDate1', true, 'href1', 'id1', true, true, 'name1', 'orderDate1', 'startDate1', 'startMode1', 'state1', 'type1', 2, 2);
